 ...
 *
 * Likes, guardados y comentarios vivieron aquí durante la Fase 4; se movieron a `posts`
 * (`PostInteractionsService`) al deshacer el ciclo de tres módulos que generaban — ver
 * `docs/ARCHITECTURE.md` y `docs/PROCESSES.md` ("Ciclo `posts` ↔ `social`").
 */
@Injectable()
