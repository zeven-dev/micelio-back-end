...
| [`docs/ORCHESTRATION.md`](docs/ORCHESTRATION.md) | Protocolo jefe+hijos entre los tres repos: orden de fase, verificación, cuándo pausar y **qué modelo usa cada cosa** (Opus 5 vs. Sonnet 5) | Solo con acuerdo del dueño del producto |
